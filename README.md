...
Or grab a prebuilt binary from the [releases](https://github.com/tamnd/opentargets-cli/releases), or run
the container image:
...
opentargets --help                           # the whole command tree
```
...
opentargets mcp                   # speak MCP over stdio
```

## Use it as a resource-URI driver

`opentargets` registers a `opentargets` domain the way a program registers a
...
```
cmd/opentargets/   thin main: hands cli.NewApp to kit.Run
