...
// HTTP behaviour is covered in opentargets_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "opentargets://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("opentargets", "about")
	if err != nil || got.String() != "opentargets://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want opentargets://page/about", got.String(), err)
	}
}
