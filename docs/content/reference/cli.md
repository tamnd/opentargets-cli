...
```
opentargets <command> [arguments] [flags]
```

Run `opentargets <command> --help` for the full flag list on any command. This
...
per operation you declare in `opentargets/domain.go`.
